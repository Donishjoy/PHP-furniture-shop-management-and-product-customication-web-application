          ...
          <div class="row">
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                  <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">Update Employee Password</h2>
                  </div>
                </div>
...
if(isset($_POST["update"]))
{
	...
	$sql="UPDATE `customer2` SET `pass`='$password',`confpass`='$confpass' WHERE `phoneno`=$phoneno AND user='emp' ";
