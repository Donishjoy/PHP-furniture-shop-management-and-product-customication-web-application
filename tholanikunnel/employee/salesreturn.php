          ...
          <div class="row">
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                  <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">Sales Return Details</h2>
                  </div>
                </div>
            ...
            <tbody border="8px">
                            <tr align="center">
                                   ...
                                   if(isset($_POST['submit'])){
                                       $pur_id=$_POST['pr_id'];
                                       $dop=$_POST['dor'];
                                       $sql = "SELECT * FROM salesreturn where billid='$pur_id' or srdate='$dop' ";
                                       $result = mysqli_query($conn, $sql);
                                      while ($rows = mysqli_fetch_array($result)) {
                                       ?>
                                          <tbody>
                          <tr align="center">
                    <td  class="td"><?php echo $rows['srid'] ?></td>
                    <td class="td"><?php echo $rows['pid'] ?></td>
                    <td class="td"><?php echo $rows['phoneno'] ?></td>
                    <td class="td"><?php echo $rows['srdate'] ?></td>
                    <td class="td"><?php echo $rows['damage'] ?></td>
                    <td class="td"><?php echo $rows['billid'] ?></td>
                    <td class="td"><?php echo $rows['srqty'] ?></td>
                   </tr>
                <?php
