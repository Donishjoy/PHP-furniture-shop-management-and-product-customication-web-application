...
<link rel="stylesheet" href="css/style123.css">
    ...
    <title>Flourish Store - HTML Template</title><link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700%7CLibre+Baskerville:400,700" rel="stylesheet">
  ...
  <body>
    ...
    <header class="header" >
      ...
      <nav class="navigation">
        <div class="ps-container"><a class="ps-logo" href="index-2.html"><img src="images/pic3.png" alt=""></a>
              <ul class="main-menu menu">
                ...
                <li><div class="header__actions"></div><li class=" menu-item-has-children"><a href="#">Account</a>
                  <ul class="sub-menu">
                    ...
                    <li><a href="file:///C:/xampp/htdocs/login/">Login&Register</a></li>
