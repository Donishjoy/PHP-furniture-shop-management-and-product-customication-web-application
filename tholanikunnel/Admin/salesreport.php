          ...
          <div class="row">
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                  <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">View Sales Details</h2>
                  </div>
                </div>
            ...
            <tbody border="5px">
              ...
              <th>AMOUNT</th>
                                   ...
                                   if(isset($_POST['submit'])){
                                       ...
                                       $dop=$_POST['date'];
                                       $sql = "SELECT id,orid,cartid,pid,phoneno,orqty,amount,DATE(ordate) AS ordate FROM custorder where  ordate='$dop' and pid !=0 ";
