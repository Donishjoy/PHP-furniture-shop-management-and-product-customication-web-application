            ...
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                ...
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-outline"></i></div><strong>Total Customer</strong>
                    </div>
                    <div class="number dashtext-1"><?php $sql = "SELECT * FROM customer2";
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-outline"></i></div><strong>Total Employee</strong>
                    </div>

                    <div class="number dashtext-3"><?php $sql = "SELECT * FROM customer2 where user='emp'";
                    if ($result = mysqli_query($conn, $sql)) {
          ...
          <div class="col-md-3 col-sm-6">
              ...
              <section>
                ...
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-three-cells"></i></div><strong>  Products on Banner</strong>
                    </div>
                    <div class="number dashtext-1"><?php $sql = "SELECT * FROM banner";
                    if ($result = mysqli_query($conn, $sql)) {
                    $rowcount1 = mysqli_num_rows( $result );
                    printf($rowcount1);
                    }
              ...
              <section>
                ...
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-three-cells"></i></div><strong> Customization Requests</strong>
                    </div>
                    <div class="number dashtext-1"><a href="customrequest.php"><?php $sql = "SELECT * FROM cutomize where custstatus='REQUEST'";
                    if ($result = mysqli_query($conn, $sql)) {
                    $rowcount1 = mysqli_num_rows( $result );
                    printf($rowcount1);
                    }
