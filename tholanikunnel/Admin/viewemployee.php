...
<html>
          ...
          <div class="row">
            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                  <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">View Employee Details</h2>
                  </div>
                </div>
    ...
    $(document).ready(function() {
      ...
      $("#phone").keypress(function (e) {
        ...
        if(isset($_POST['submit'])){
            ...
            $sql ="SELECT * FROM `customer2` WHERE `user`='emp' AND (phoneno=$phoneno) ";
            ...
            ?>
               ...
               <tr> <td align="center"><?php echo $rows['username'] ?></td>
                ...
                <td align="center"><a target="_self" href="viewcustomer.php?delete=<?php  echo $rows['phoneno'];?>" type="submit"  class="btn btn-primary">Delete</a></td></tr>
            <?php
          }
        }
    ...
    if (isset($_GET['delete'])) {
      ...
      if ($delete_query) {
          echo "<script> alert('Employee details deleted');window.location='viewemployee.php';</script>";
      } else {
          echo "<script> alert('Employee is  not deleted from the cart');window.location='viewemployee.php';</script>";
      }
  }
?>
        </div>
