...
$e="SELECT * FROM `customer2` where phoneno=$ph AND user='admin'";
      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <div class="list-inline-item logout">                   <a id="logout" href="../../login/login.php" onclick="<? session_destroy(); ?>" class="nav-link">Logout <i class="icon-logout"></i></a></div>
          </div>
        </div>
      </nav>
    </header>
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-website"></i>Orders </a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                  <li><a href="order.php">Customer order details</a></li>
                  <li><a href="order.php">Update  order details</a></li>
                  <li><a href="customizeorder.php">Customized order details</a></li> 
                  <li><a href="order.php">Update customize order details</a></li>
                  </ul>
                </li>
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-page"></i>Stocks </a>
                  ...
                  <li><a href="updatestock.php">Update stock details</a></li>  </ul>
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user-outline"></i>Customer </a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user-outline"></i>Employee </a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
        ...
        <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user-outline"></i>Banner </a>
          <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
        ...
        <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-user-outline"></i>Profile </a>
          <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
            <li><a href="forgotpassword.php">Update Password </a></li>
